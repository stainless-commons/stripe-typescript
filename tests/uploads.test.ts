import fs from 'fs';
import type { ResponseLike } from 'stripe-minimal/internal/to-file';
import { toFile } from 'stripe-minimal/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('stripe-minimal/core/uploads');
    await expect(
